...
(define/provide-test-suite
  ...
  (check-equal? #f (convert-base "10" "2f" "14"))
  (check-equal? #f (convert-base "500" "14" "n"))
  (check-equal? #f (convert-base "5" "4" "14"))
  (check-equal? #f (convert-base "344" "2" "14"))
  (check-equal? #f (convert-base "100" "17" "14"))
  (check-equal? #f (convert-base "100" "14" "17"))
  (check-equal? #f (convert-base "100" "1" "14"))
  (check-equal? #f (convert-base "100" "14" "1")))